...
<CrossCourseRef
  ...
  lessonSlug="04-smart-contracts-func/05-gas-optimization"
  label="FunC/Tolk: оптимизация газа на практике"
  preview="Конкретные приёмы экономии газа в FunC и Tolk: горячие инструкции TVM, переиспользование cells, layout state"
/>

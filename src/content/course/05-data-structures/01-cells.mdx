...
<CrossCourseRef
  ...
  lessonSlug="02-tvm-execution/05-tvm-stack-machine"
  label="TVM: стек-машина и cells"
  preview="Как TVM работает со стеком ячеек: загрузка, сериализация, потребление газа на парсинг и сборку cells"
/>

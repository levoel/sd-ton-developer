...
<CrossCourseRef
  ...
  lessonSlug="01-ton-architecture/03-workchains-sharding"
  label="TON: workchains и shardchains"
  preview="Как устроены workchains и shardchains, динамический split/merge и роутинг сообщений между шардами"
/>
